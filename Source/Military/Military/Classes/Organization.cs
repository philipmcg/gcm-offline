...
namespace Military
{
    ...
    partial class Organization : IComparable<Organization>
    {
        ...
        public void AddOrganizationToFirstSlot(Organization org)
        {
            this.AddOrganization(org);
            int index1 = this.m_organizations.IndexOf(org);
            if (index1 != 0)
            {
                var currentOrg0 = this.m_organizations[0];
                this.m_organizations[index1] = currentOrg0;
                this.m_organizations[0] = org;
            }
        }
