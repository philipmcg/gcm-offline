...
namespace Utilities
{
    public static class DirectoryEx
    {
        ...
        /// </summary>
        public static void CopyContentsRecentlyModified(string sourcePath, string destinationPath, DateTime sinceDate)
        {
          var source = new DirectoryInfo(sourcePath);
          var dest = new DirectoryInfo(destinationPath);
          CopyFilesRecursivelyRecentlyModified(source, dest, sinceDate);
        }

        static void CopyFilesRecursivelyRecentlyModified(DirectoryInfo source, DirectoryInfo target, DateTime sinceDate)
        {
          foreach (DirectoryInfo dir in source.GetDirectories())
            CopyFilesRecursivelyRecentlyModified(dir, target.CreateSubdirectory(dir.Name), sinceDate);
